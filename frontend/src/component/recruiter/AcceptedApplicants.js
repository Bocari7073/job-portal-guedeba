              ...
              >
                ...
                <Grid item>
                  <label htmlFor="dateOfJoining">
                    <Typography>Date d'entrée en fonction</Typography>
                  </label>
                </Grid>
                <Grid item>
                  <IconButton
    ...
    <Paper className={classes.jobTileOuter} elevation={3}>
      <Grid container>
        ...
        <Grid container item xs={7} spacing={1} direction="column">
          ...
          <Grid item>Titre d'emploi: {application.job.title}</Grid>
          <Grid item>Rôle: {application.job.jobType}</Grid>
          <Grid item>Appliqué le: {appliedOn.toLocaleDateString()}</Grid>
          <Grid item>
