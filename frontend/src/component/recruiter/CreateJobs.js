...
const CreateJobs = (props) => {
  ...
  return (
    <>
      ...
      >
        <Grid item>
          <Typography variant="h2">Ajouter une offre d'emploi</Typography>
        </Grid>
              ...
              >
                ...
                <Grid item>
                  <ChipInput
                    ...
                    variant="outlined"
                    helperText="Appuyez sur Entrée après avoir saisi chaque compétence"
                ...
                <Grid item>
                  <TextField
                    label="Nombre maximal de candidats"
                    type="number"
                    variant="outlined"
