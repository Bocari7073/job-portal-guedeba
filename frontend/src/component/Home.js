        ...
        <Grid container direction="column" alignItems="center" spacing={3}>
          ...
          <Grid container item alignItems="center">
            ...
            <Grid item xs={9}>
              ...
              >
                <MenuItem value="0">Toute</MenuItem>
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Grid item xs>
            <Typography variant="h2">Emplois</Typography>
          </Grid>
          <Grid item xs>
            <TextField
              label="Recherche d'emplois"
